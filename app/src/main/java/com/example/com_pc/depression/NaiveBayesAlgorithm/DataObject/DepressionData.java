package com.example.com_pc.depression.NaiveBayesAlgorithm.DataObject;
...
public class DepressionData {
        ...
        public double depLivingStandard(){
            if(livingStandard.equalsIgnoreCase("above average")){
        ...
        public double notDepLivingStandard(){
            if(livingStandard.equalsIgnoreCase("above average")){
        ...
        public double depArguingWithParents() {
            if (arguingWithParents) {
        ...
        public double notDepArguingWithParents() {
            if (arguingWithParents) {
        ...
        public double depLoosingFriend() {
            if (loosingFriend) {
        ...
        public double notDepLoosingFriend() {
            if (loosingFriend) {
        ...
        public double depTroubleWithSiblings() {
            if (troubleWithSiblings) {
        ...
        public double notDepTroubleWithSiblings() {
            if (troubleWithSiblings) {
        ...
        public double depTroubleWithTeacher() {
            if (troubleWithTeacher) {
        ...
        public double notDepTroubleWithTeacher() {
            if (troubleWithTeacher) {
        ...
        public double notDepSeriouslyIll() {
            if (seriouslyIll) {
        ...
        public double depParentsArguing() {
            if (parentsArguing) {
        ...
        public double notDepParentsArguing() {
            if (parentsArguing) {
        ...
        public double depFamilyMemberIll() {
            if (familyMemberIll) {
        ...
        public double notDepFamilyMemberIll() {
            if (familyMemberIll) {
        ...
        public double depTroubleWithClassmates() {
            if (troubleWithClassmates ) {
        ...
        public double notDepTroubleWithClassmates() {
            if (troubleWithClassmates ) {
        ...
        public double depParentsMaritalStatus(){
            if(parentsMaritalStatus.equalsIgnoreCase("married")){
        ...
        public double notDepParentsMaritalStatus(){
            if(parentsMaritalStatus.equalsIgnoreCase("married")){
